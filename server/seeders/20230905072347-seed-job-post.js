...
module.exports = {
  async up(queryInterface, Sequelize) {
    queryInterface.bulkInsert('job_post', [
      {
        ...
        apply_at: '2023-05-26 02:31:35',
        expired_at: '2024-07-02 10:26:36',
        experience: 2,
      },
      {
      ...
      },
      {
        ...
        apply_at: '2022-01-24 01:15:08',
        expired_at: '2024-04-04 07:19:52',
        experience: 2,
      },
      {
        title: 'Actor',
    ...
    return queryInterface.sequelize.query(
      `UPDATE job_post 
       SET state = 2 
       WHERE DATE(expired_at) > CURRENT_DATE AND DATE(apply_at) < CURRENT_DATE AND state = 3;`,
    );
  },
